...
namespace RayTracerDemo
{
    class Program
    {
        ...
        {
            Cylinder c = new Cylinder {Position = new Vector3(0, 0.5f, -2), Scale = 1, Rotation = new Vector3(-0, -0.34f, 3.14f / 2), Material = new Diffuse(Color.FromColor4(Color4.Orange))};
